...
Let's take a quick high level overview of our file structure and what `generator-electrode` gives you out the box. Read through our [What's Inside](whats_inside.html) section for a more detailed description.
...
Open [localhost:3000](http://localhost:3000) in your browser. Hello Electrode! Let's continue to [build](build_component.html) by modifying our component and deploying in [Quick Start: Build Component](build_component.html).
