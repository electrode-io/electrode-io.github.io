...
Override the code in
`<your-awesome-component>/src/components/your-awesome-component.jsx` with the
code below. Change all references from the literal `your-awesome-component or
