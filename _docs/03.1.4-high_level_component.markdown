...
```
Last edit! In your `<your-awesome-component>/src/index.js` add the three lines below:

```javascript
  export { default as YourAwesomeComponent } from "./src/components/your-awesome-component";
