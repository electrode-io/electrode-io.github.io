...
Please follow Microsoft&#8482;'s guide to setting up the client SDK for React&#8482; [here](https://microsoft.github.io/code-push/docs/react-native.html) and
Cordova&#8482; [here](https://microsoft.github.io/code-push/docs/cordova.html). 

Then come back here to configure your app to use the OTA Server.
