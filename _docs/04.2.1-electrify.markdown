...
for catching large and/or duplicate modules which might be either bloating your
bundle or slowing down the build process.
...
for tracking down code generated from a transform that's bloating your bundle
more than expected.
