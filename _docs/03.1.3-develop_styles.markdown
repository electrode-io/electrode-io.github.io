...
application. Replace the code in `<your-awesome-component>/src/styles/your-awesome-component.css`
with the code below:
...
Create a file named: `<your-awesome-component>/src/styles/guest-list.css`. Copy
...
Create a file named: `<your-awesome-component>/src/styles/render-friend.css`.
