...
Let's also add some style elements using [CSS modules](https://github.com/css-modules/css-modules) to create a dynamic application. Override the below code into your `<your-awesome-component>/src/styles/your-awesome-component.css`:
