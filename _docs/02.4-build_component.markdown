...
After you've generated your awesome electrode app, you're ready to focus on
writing your React components.
...
We'll need a place to keep all of the resources we learned about in the [Get
Started] section. Let's make a visual library for all these exciting
technologies! Copy the code below and paste it into
...
Let's finish the UI by adding styles. Navigate to
`<your-awesome-app>/client/styles/base.css` and add the code below:
...
> If you are already running your app in dev mode, then your changes should've
> been updated automatically and you can just refresh your browser to see the
> changes.
...
Now let's jump to our next step, where we will deploy Your Awesome App to
[Heroku].

[Get Started]: get_started.html
[https://localhost:3000]: https://localhost:3000
[Heroku]: deploy_app.html
