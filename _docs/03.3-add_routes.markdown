...
Navigate to `<your-awesome-app>/client/components`. Create a file with the name of your-awesome-component (the same from [Create a Standalone component](create_standalone_component.html)). The path for this component will look like this: `<your-awesome-app>/client/components/your-awesome-component.jsx` Copy, paste and save the code below into this file:
...
Navigate to `<your-awesome-app>/client/components`. Create a file with the name of `render-friend.jsx`. The path for this component will look like this: `<your-awesome-app>/client/components/render-friend.jsx` Copy, paste and save the code below into this file. Change the `import styles from "../styles/your-awesome-component.css";` line to your actual awesome-component.css:
...
Navigate to `<your-awesome-app>/client/components`. Create a file with the name of `guest-list.jsx`. The path for this component will look like this: `<your-awesome-app>/client/components/guest-list.jsx` Copy, paste and save the code below into this file. Remember: change the `import styles from "../styles/your-awesome-component.css";` line to your actual awesome-component.css:
...
Whew, last step. Create a folder called `helpers` inside of `client`. Create a file here called `graph-styles.js`. It will now look like this: `<your-awesome-component>/client/helpers/graph-styles.js`. We will discuss this helper more later. Copy, paste and save the code below into this file:
