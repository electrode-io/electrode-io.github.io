...
Now, the fun part! We'll be building out `your-awesome-component` and adding two sub-components (or dumb components). Trust me, it will be worth it.
...
Let's continue to build more by creating a [Hapi server plugin](server_config.html).
