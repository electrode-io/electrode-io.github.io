...
Now, the fun part! We will be building out `your-awesome-component.jsx` and adding two sub-components (or dumb components). Trust me, it will be worth it.

In your `<your-awesome-component>/src/components/your-awesome-component.jsx`, delete what is inside and copy, paste and save the code below into this file. Change all references from the literal `your awesome component` to your actual component name:
...
In your `<your-awesome-component>/src/style/your-awesome-component.css`, delete what is inside and copy, paste and save the code below into this file:
