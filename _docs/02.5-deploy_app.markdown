...
Use the command below to set a configuration that for [production.js](https://github.com/docs-code-examples-electrode-io/electrode-example-app-with-plugin-and-routes/blob/master/config/production.js#L11):
...
And... you did it! [Click here](https://electrode-example-party-app.herokuapp.com/) for our deployed Heroku version.
We will build even more in our [Getting Started: Intermediate](create_standalone_component.html) and cover complex topics like routing, server plugins and other powerful deployment software.
