...
Let's finish the UI by adding styles. Navigate to <your-awesome-app>/client/styles/base.styl and add the code below. A reminder: [Stylus](http://stylus-lang.com/) is white-space-sensitive.
