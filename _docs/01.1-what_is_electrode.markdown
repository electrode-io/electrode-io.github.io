...
**It only takes a minute to set your new Electrode application up and a few more minutes to deploy to the cloud [Getting Started: Quick Guide](quick_guide.html).**
