...
#### Core: Quick + Easy
The heart of the platform is [Electrode Archetypes](https://github.com/electrode-io?utf8=%E2%9C%93&query=archetype%20only%3Asources%20). It allows for standardized configurations/structure of the app and its associated react components, also ensures streamlined development and deployment. It only takes five minutes with our [Getting Started: Quick Guide](quick_guide.html)
